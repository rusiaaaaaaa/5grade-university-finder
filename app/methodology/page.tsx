      ...
      <div className="mx-auto max-w-5xl space-y-8">
        <div>
          ...
          <p className="mt-3 leading-8 text-stone-700">
            5등급제 내신대학찾기는 공식 입시 판단이 아니라 참고 도구입니다. 현재 버전은 {GRADE_SCALE.label} 기준으로
        ...
        <section className="rounded-lg border border-stone-200 bg-white p-6 shadow-soft">
          ...
          <p className="mt-3 leading-7 text-stone-700">
            ...
            적합도입니다. 최종 점수 S는 100점 만점의 참고 지표이며, 합격 가능성과 동일하지 않습니다.
          </p>
        ...
        <section className="rounded-lg border border-stone-200 bg-white p-6 shadow-soft">
          ...
          <p className="mt-3 leading-7 text-stone-700">
            ...
            면접, 서류 평가, 생기부 맥락은 단순 평균 모델만으로 판단할 수 없습니다.
          </p>
        </section>
      </div>
    </section>
